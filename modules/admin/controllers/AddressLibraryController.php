...
class AddressLibraryController extends Controller
{
    ...
    /**
     * Displays a single AddressLibrary model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new AddressLibrary model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new AddressLibrary();

        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['view', 'id' => $model->Address_Library_Id]);
        } else {
    ...
    /**
     * Updates an existing AddressLibrary model.
    ...
    /**
     * Deletes an existing AddressLibrary model.
